...
mixin _$NetworkExceptions {
  ...
  Result when<Result extends Object>({
    ...
    @required Result unprocessableEntity(),
  ...
  Result map<Result extends Object>({
    ...
    @required Result unprocessableEntity(UnProcessableEntity value),
  ...
  Result maybeMap<Result extends Object>({
    ...
    Result unprocessableEntity(UnProcessableEntity value),
...
class _$UnProcessableEntity implements UnProcessableEntity {
  ...
  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is UnProcessableEntity);
  }
...
abstract class UnProcessableEntity implements NetworkExceptions {
  const factory UnProcessableEntity() = _$UnProcessableEntity;
}
